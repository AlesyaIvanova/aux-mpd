...
CHECKPOINT_PATH = 'models11/checkpoint_3300.pth'
CHI_LOAD_FILE = 'evaluation11/chi_metric/chi_metric.npy'
CHI_SEP_LOAD_FILE = 'evaluation11/chi_metric_sep/chi_metric_sep.npy'
