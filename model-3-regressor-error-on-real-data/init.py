...
CHECKPOINT_PATH = 'models2/checkpoint_9150.pth'
CHI_LOAD_FILE = 'evaluation2/chi_metric/chi_metric.npy'
CHI_SEP_LOAD_FILE = 'evaluation2/chi_metric_sep/chi_metric_sep.npy'
...
def make_dirs():
    ...
    os.mkdir('evaluation/chi_metric_sep')
