...
CHECKPOINT_PATH = 'models6/checkpoint_4400.pth'
CHI_LOAD_FILE = 'evaluation6/chi_metric/chi_metric.npy'
CHI_SEP_LOAD_FILE = 'evaluation6/chi_metric_sep/chi_metric_sep.npy'
